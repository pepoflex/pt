        ...
        item.click(function () {
            ...
            if (jQuery('.dark-wrapper.fixed').length == 0) {
                ...
                jQuery('body').append('<div class="navcoverpage"></div>' +
                    ...
                    '<a href="#"  id="gwi-thumbs" title="Todos los Trabajos"><i class="icon-th"></i></a>' +
                    '<a href="#"  id="gwi-prev" title="Anterior"><i class="icon-left-open-1"></i></a>' +
                    '<a href="#"  id="gwi-next" title="Siguiente"><i class="icon-right-open-1"></i></a>' +
                    '</div>' +
                    '<div class="clear"></div>' +
                    '</div>' +
                    '</div>' +
